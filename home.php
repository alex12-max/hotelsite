...
{  
    ...
    header("Location: templates/login.php");//redirect to the login page to secure the welcome page without login access.  
}  
...
<html>
	...
	<div class="navbar">
		...
		<div class="nav_right">
			<ul>
                <li class="nr_li">
					<a href="profiel.php"><i class="fas fa-cart-arrow-down"></i></a>
				</li>
				<li class="nr_li dd_main">
					...
					<div class="dd_menu">
						...
						<div class="dd_right">
							<ul>
								<li><a style="text-decoration: none;" href = "templates/profiel.php">Profiel</a></li>
								<li><a style="text-decoration: none;" href = "templates/logout.php">Logout</a></li>
							</ul>
						</div>
					</div>
				</li>
        ...
        <header class = "header" id = "header">
            ...
            <form  class = "book-form" id="reservation">
                <div class = "form-item">
